                        ...
                        <li>
                            <strong>Verificar la Instalación:</strong>
                             <ul className="list-[circle] space-y-2 pl-5 mt-2 text-sm">
                                 ...
                                 <li>Si todo sale bien, la consola mostrará un mensaje de "¡ÉXITO!" y el estado final del servicio (`Running`). La ventana permanecerá abierta hasta que presiones una tecla.</li>
