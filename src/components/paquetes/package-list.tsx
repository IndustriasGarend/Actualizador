...
import { MoreHorizontal, Edit, Trash2, Package as PackageIcon, FileCode, Terminal, ListChecks } from 'lucide-react';
                                ...
                                {packages.map((pkg) => {
                                  ...
                                  return (
                                    <TableRow key={pkg.id}>
                                        ...
                                        <TableCell>
                                            <Badge variant={details.variant as any} className={pkg.packageType === 'registro_componentes' ? 'bg-cyan-600 hover:bg-cyan-700 text-white' : ''}>
